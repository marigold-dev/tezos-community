...
type Methods = {
    ...
    addOrganization: (autoRegistration: boolean, business: string, fundingAddress: {
        Some: address;
    } | null, ipfsNftUrl: string, logoUrl: string, name: string, siteUrl: string) => Promise<void>;
    addTezosAdmin: (param: address) => Promise<void>;
    changeLimits: (adminsMax: nat, memberRequestMax: nat, organizationMax: nat) => Promise<void>;
    freezeOrganization: (param: string) => Promise<void>;
    removeAdmin: (admin: address, lastAdmin: {
        Some: address;
    } | null, orgName: string) => Promise<void>;
    ...
    responseToJoinOrganization: (membersToApprove: Array<address>, membersToDecline: Array<address>, orgName: string) => Promise<void>;
    sendMessage: (_0: string, _1: string) => Promise<void>;
    updateOrganization: (autoRegistration: boolean, business: string, fundingAddress: {
        Some: address;
    } | null, ipfsNftUrl: string, logoUrl: string, name: string, siteUrl: string) => Promise<void>;
};
type MethodsObject = {
