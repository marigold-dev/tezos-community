...
```bash
TAQ_LIGO_IMAGE=ligolang/ligo:0.70.1 taq compile nft.jsligo
```
...
```bash
TAQ_LIGO_IMAGE=ligolang/ligo:0.70.1 taq test test.jsligo
```
...
```
TAQ_LIGO_IMAGE=ligolang/ligo:ligo:0.70.1 taq compile main.jsligo
taq deploy main.tz -e "testing" --storage main.storage.ghostnet.tz
